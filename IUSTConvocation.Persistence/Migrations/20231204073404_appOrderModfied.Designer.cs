...
namespace IUSTConvocation.Persistence.Migrations
{
    ...
    [Migration("20231204073404_appOrderModfied")]
    partial class appOrderModfied
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IUSTConvocation.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("d18991a1-baaf-4509-877a-ab05934348bd"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 12, 4, 13, 4, 4, 101, DateTimeKind.Unspecified).AddTicks(6358), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            UpdatedBy = new Guid("5ac50b96-5d2e-462b-8732-7593f83bacc4"),
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 12, 4, 13, 4, 4, 101, DateTimeKind.Unspecified).AddTicks(6371), new TimeSpan(0, 5, 30, 0, 0)),
                            UserRole = (byte)1,
                            UserStatus = (byte)1,
                            Username = "admin"
                        });
