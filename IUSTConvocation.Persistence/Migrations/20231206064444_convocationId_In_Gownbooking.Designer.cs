...
namespace IUSTConvocation.Persistence.Migrations
{
    ...
    [Migration("20231206064444_convocationId_In_Gownbooking")]
    partial class convocationId_In_Gownbooking
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IUSTConvocation.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("f081b904-ecdb-4099-99ac-2060957ab741"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 12, 6, 12, 14, 44, 214, DateTimeKind.Unspecified).AddTicks(5286), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            UpdatedBy = new Guid("ff304138-8fdf-466f-9246-24559249395d"),
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 12, 6, 12, 14, 44, 214, DateTimeKind.Unspecified).AddTicks(5297), new TimeSpan(0, 5, 30, 0, 0)),
                            UserRole = (byte)1,
                            UserStatus = (byte)1,
                            Username = "admin"
                        });
            ...
            modelBuilder.Entity("IUSTConvocation.Domain.Entities.GownBooking", b =>
                {
                    b.HasOne("IUSTConvocation.Domain.Entities.Convocation", "Convocation")
                        .WithMany("GownBookings")
                        .HasForeignKey("ConvocationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("IUSTConvocation.Domain.Entities.Gown", "Gown")
                        .WithMany("GownBookings")
