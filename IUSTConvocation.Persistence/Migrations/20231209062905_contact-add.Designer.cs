...
namespace IUSTConvocation.Persistence.Migrations
{
    ...
    [Migration("20231209062905_contact-add")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IUSTConvocation.Domain.Entities.Contact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IUSTConvocation.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("41079267-fc63-488d-b849-c8475336df47"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 12, 9, 11, 59, 5, 565, DateTimeKind.Unspecified).AddTicks(9505), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            UpdatedBy = new Guid("1e44953c-80ba-426a-95e7-f5dd76f9a938"),
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 12, 9, 11, 59, 5, 565, DateTimeKind.Unspecified).AddTicks(9516), new TimeSpan(0, 5, 30, 0, 0)),
                            UserRole = (byte)1,
                            UserStatus = (byte)1,
                            Username = "admin"
                        });
