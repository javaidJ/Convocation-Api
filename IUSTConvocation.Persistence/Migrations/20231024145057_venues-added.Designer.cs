...
namespace IUSTConvocation.Persistence.Migrations
{
    ...
    [Migration("20231024145057_venues-added")]
    partial class venuesadded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IUSTConvocation.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("d6790fa8-3f81-4e8e-aca8-47c6857748cd"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 10, 24, 20, 20, 56, 977, DateTimeKind.Unspecified).AddTicks(8858), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            UpdatedBy = new Guid("82c9d0ff-c22c-4209-9e8d-fe24e27049ea"),
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 10, 24, 20, 20, 56, 977, DateTimeKind.Unspecified).AddTicks(8869), new TimeSpan(0, 5, 30, 0, 0)),
                            UserRole = (byte)1,
                            UserStatus = (byte)1,
                            Username = "admin"
                        });
